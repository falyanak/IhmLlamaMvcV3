IF EXISTS(SELECT * FROM SYSOBJECTS WHERE NAME='PROFIL_PLUS_S_AGENTS_TOUS_PARTENAIRES')
DROP PROCEDURE PROFIL_PLUS_S_AGENTS_TOUS_PARTENAIRES
GO

CREATE PROCEDURE [dbo].[PROFIL_PLUS_S_AGENTS_TOUS_PARTENAIRES]
AS
/*   
Auteur: François Alyanakian
Date de création: 3/11/2023
-------------------------------------------------------------------------------------------------------
Description : extrait la liste des agents de tous les partenaires :  DGAL, DGDDI, SCL
-------------------------------------------------------------------------------------------------------
Modification :  11/01/2024
                ajout champ sexe
-------------------------------------------------------------------------------------------------------		
Test :
        Exec PROFIL_PLUS_S_AGENTS_TOUS_PARTENAIRES
...
GO
/*
GRANT EXECUTE ON PROFIL_PLUS_S_AGENTS_TOUS_PARTENAIRES TO SELECTEXEC
*/