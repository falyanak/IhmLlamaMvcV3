IF EXISTS(SELECT * FROM SYSOBJECTS WHERE NAME='PROFIL_PLUS_S_AGENT_PRESENT_COMPTEAD_OU_MAIL_DOUBLON_EXCLUANT_AGENTID')
DROP PROCEDURE PROFIL_PLUS_S_AGENT_PRESENT_COMPTEAD_OU_MAIL_DOUBLON_EXCLUANT_AGENTID
GO

CREATE PROCEDURE [dbo].[PROFIL_PLUS_S_AGENT_PRESENT_COMPTEAD_OU_MAIL_DOUBLON_EXCLUANT_AGENTID]
(
    @COMPTEAD varchar(30),
    @MAIL varchar(100),
    @AGENTID smallint
...
-------------------------------------------------------------------------------------------------------
Test :
        Exec PROFIL_PLUS_S_AGENT_PRESENT_COMPTEAD_OU_MAIL_DOUBLON_EXCLUANT_AGENTID 
        COMPTEAD = 'login' 'mail' 'agentid'
...
GO
/*
GRANT EXECUTE ON PROFIL_PLUS_S_AGENT_PRESENT_COMPTEAD_OU_MAIL_DOUBLON_EXCLUANT_AGENTID TO SELECTEXEC
*/