IF EXISTS(SELECT * FROM SYSOBJECTS WHERE NAME='PROFIL_PLUS_S_UN_AGENT_PAR_MAIL_DANS_REFERENTIEL')
DROP PROCEDURE PROFIL_PLUS_S_UN_AGENT_PAR_MAIL_DANS_REFERENTIEL
GO

CREATE PROCEDURE [dbo].[PROFIL_PLUS_S_UN_AGENT_PAR_MAIL_DANS_REFERENTIEL]
(
    @MAIL varchar(100)
...
-------------------------------------------------------------------------------------------------------		
Test :
        Exec PROFIL_PLUS_S_UN_AGENT_PAR_MAIL_DANS_REFERENTIEL  @IDENT = 'agent_id'
...
GO
/*
GRANT EXECUTE ON PROFIL_PLUS_S_UN_AGENT_PAR_MAIL_DANS_REFERENTIEL TO SELECTEXEC
*/