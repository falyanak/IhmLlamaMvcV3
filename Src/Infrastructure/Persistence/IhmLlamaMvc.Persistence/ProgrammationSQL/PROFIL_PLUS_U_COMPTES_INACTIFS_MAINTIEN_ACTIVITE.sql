IF EXISTS(SELECT * FROM SYSOBJECTS WHERE NAME='PROFIL_PLUS_U_COMPTES_INACTIFS_MAINTIEN_ACTIVITE')
DROP PROCEDURE PROFIL_PLUS_U_COMPTES_INACTIFS_MAINTIEN_ACTIVITE
GO

CREATE PROCEDURE [dbo].[PROFIL_PLUS_U_COMPTES_INACTIFS_MAINTIEN_ACTIVITE]
...
BEGIN TRY
    ...
    UPDATE PROFIL_PLUS_Gestion_Compte_Inactif 
      SET PFL_PLUS_DateMaintienActivite = @DateMaintienActivite,
...
GO
/*
GRANT EXECUTE ON PROFIL_PLUS_U_COMPTES_INACTIFS_MAINTIEN_ACTIVITE TO SELECTEXEC
*/
