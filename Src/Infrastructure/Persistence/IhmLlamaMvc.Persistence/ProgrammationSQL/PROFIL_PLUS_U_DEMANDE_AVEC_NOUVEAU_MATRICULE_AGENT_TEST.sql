IF EXISTS(SELECT * FROM SYSOBJECTS WHERE NAME='PROFIL_PLUS_U_DEMANDE_AVEC_NOUVEAU_MATRICULE_AGENT_TEST')
DROP PROCEDURE PROFIL_PLUS_U_DEMANDE_AVEC_NOUVEAU_MATRICULE_AGENT_TEST
GO


CREATE PROCEDURE [dbo].PROFIL_PLUS_U_DEMANDE_AVEC_NOUVEAU_MATRICULE_AGENT_TEST (
...
UPDATE PROFIL_PLUS_Demande 
       set 
           Ag_Ident_ConcerneParDemande = @AgentId,
...
GO
/*
GRANT EXECUTE ON PROFIL_PLUS_U_DEMANDE_AVEC_NOUVEAU_MATRICULE_AGENT_TEST TO SELECTEXEC
*/
